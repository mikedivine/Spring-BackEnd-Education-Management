...
public class AssignmentController {
    ...
    public List<AssignmentDTO> getAssignments(
      ...
      Principal principal
        ...
        verifyInstructor(principal.getName(), s.getInstructorEmail());
    ...
    public List<AssignmentStudentDTO> getStudentAssignments(
      ...
      @RequestParam("semester") String semester) {
        ...
        List<Section> sections = sectionRepository.findByStudentIdAndYearAndSemester(user.getId(), year, semester);
        ...
        for (Section section : sections) {
            ...
            for(Assignment assignment : assignments) {
                ...
                Enrollment enrollment = enrollmentRepository.findEnrollmentBySectionNoAndStudentId(
                  section.getSectionNo(), user.getId());
                Grade grade = gradeRepository.findByEnrollmentIdAndAssignmentId(
